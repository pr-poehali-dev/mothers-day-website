      ...
      <Card className="p-8 md:p-12 bg-white/90 backdrop-blur shadow-xl border-primary/30">
        ...
        <div className="prose prose-lg max-w-none space-y-6 text-muted-foreground">
          ...
          <p className="text-lg leading-relaxed">
            ...
            не засыпал, гладила по голове и пела колыбельные. Помнишь все те моменты, когда мне было страшно 
            или больно? Ты всегда была рядом и говорила, что всё будет хорошо. 
          ...
          <p className="text-lg leading-relaxed">
            ...
            чтобы у меня было всё необходимое. Я вижу, сколько сил и времени ты вкладываешь в нашу семью — 
            и это для меня дороже всех сокровищ мира, потому что это следы твоей любви и заботы.
          </p>

          <p className="text-lg leading-relaxed">
            Прости меня за все слёзы, что я заставил тебя пролить. За все те моменты, 
            когда я не ценил то, что ты делаешь, когда был невнимателен или капризничал. 
